    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CostMethod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IncludeCommission = table.Column<bool>(type: "bit", nullable: false),
                    ManualPricesJson = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LedgerEntries_UserId_Symbol",
                table: "LedgerEntries",
